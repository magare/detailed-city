...
export function createCityLighting(scene: THREE.Scene): void {
  const ambient = new THREE.HemisphereLight(0xd9eef7, 0x26331f, 1.2);
  ...
  const skylineFill = new THREE.DirectionalLight(0x8fb8ff, 0.85);
