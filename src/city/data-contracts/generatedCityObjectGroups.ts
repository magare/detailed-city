...
const RENDER_LAYER_KIND_GROUPS = [
  ...
  },
  {
    ...
    objectKinds: ['road-segment', 'lane-marking'] as const
  },
  {
    id: 'buildings',
  ...
  },
  {
    ...
    objectKinds: ['park', 'tree-planting', 'street-light', 'street-furniture'] as const
  },
  {
    id: 'agents',
  ...
  },
  {
    ...
    objectKinds: ['constraint', 'vertical-slice'] as const
  }
] as const;
