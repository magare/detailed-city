...
export const DEFAULT_RENDER_BINDINGS = [
  ...
  {
    id: 'binding:civic:education-anchor',
    objectKind: 'education-anchor',
    semanticTag: 'education-anchor',
    assetId: 'asset:building:education-anchor:primitive',
    materialZone: 'civic',
    fallbackMaterial: 'building',
    fallbackGeometry: 'education-anchor-marker'
  },
  {
    id: 'binding:civic:healthcare-anchor',
    objectKind: 'healthcare-anchor',
    semanticTag: 'healthcare-anchor',
    assetId: 'asset:building:healthcare-anchor:primitive',
    materialZone: 'civic',
    fallbackMaterial: 'building',
    fallbackGeometry: 'healthcare-anchor-marker'
  },
  {
    id: 'binding:civic:emergency-service-anchor',
    objectKind: 'emergency-service-anchor',
    semanticTag: 'emergency-service-anchor',
    assetId: 'asset:building:emergency-service-anchor:primitive',
    materialZone: 'civic',
    fallbackMaterial: 'building',
