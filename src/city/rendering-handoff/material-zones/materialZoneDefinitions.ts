...
export const MATERIAL_ZONE_DEFINITIONS = [
  ...
  defineZone('green-stormwater', 'Green Stormwater Surface', 'foliage', 'roofGreen', 'stormwater-planting'),
  defineZone('green-stormwater-planting', 'Green Stormwater Planting', 'foliage', 'treeCanopy', 'stormwater-planting'),
  defineZone('green-stormwater-permeable', 'Green Stormwater Permeable Paving', 'concrete', 'plazaHardscape', 'stormwater-permeable'),
  defineZone('green-stormwater-curb-cut', 'Green Stormwater Curb Cut', 'concrete', 'refugeIsland', 'stormwater-curb-cut'),
  ...
  defineZone('street-light-cone', 'Street Light Cone', 'sign', 'streetLightCone', 'street-lighting'),
