...
The first executable export is `procedural-seed-json`. It carries the active seed/config, geospatial frame, bounds, LOD policy, performance budget, generated domain sections, asset catalog, render bindings, stable object IDs/counts, validation result, and deterministic provenance. Operations asset inventory records, maintenance operations, permit/inspection records, sensors/IoT telemetry, public-realm curb activations, public amenities, building fire-safety profiles, healthcare anchors, education anchors, emergency service anchors, emergency equipment, water transport access points, wind comfort zones, economy anchors, and office workplaces are exported as domain data so ownership, lifecycle, condition, source, replacement-cost audits, repair queues, temporary closures, approvals, inspections, compliance status, sensor coverage, telemetry cadence, privacy tags, seasonal curb use, barriers, seating, comfort fixtures, utility service, fire lanes, hydrant reach, egress, refuge areas, sprinkler service, emergency access, hospital/clinic/pharmacy capacity, patient arrivals, ambulance access, healthcare coverage, school/library/university/childcare capacity, learner demand, education drop-off access, playground links, pedestrian coverage, dispatch bases, response coverage, staging areas, shelter capacity, AED/phone/alarm access, assembly capacity, nearest shelter and assembly coverage, ferry/port/helipad capacity, water/air arrival constraints, pedestrian wind warnings, jobs, customer demand, delivery demand, opening hours, frontage needs, loading needs, district fit, lobbies, office floor area, tenancy, commute mode demand, peak arrivals/departures, and daytime population do not require renderer-only state. The export intentionally excludes renderer-only and runtime inspection fields such as `objectIndex`, scene layers, overlays, picking catalogs, runtime performance, quality flags, and traffic validation snapshots.
...
| Public amenity | Parent sidewalk/plaza/waterfront open space, amenity kind, placement context, road/sidewalk or public-space references, service access corridor, position, clearance envelope, accessible path, capacity, comfort metrics, utility requirements, LOD tier, and asset binding. |
...
| Building fire safety | Parent building, parcel/road references, risk class, hydrant node and reach, fire-lane curb zones, egress/emergency entrance IDs, service access corridors, sprinkler service, refuge areas, LOD tier, and emergency-access flags. |
| Healthcare anchor | Parent healthcare civic anchor, building/parcel/district/road/service-area references, hospital/clinic/pharmacy/urgent-care/ambulance-bay kind, patient arrival demand, entrance/transit/ambulance access refs, bed/exam/pharmacy/urgent/ambulance capacity, coverage navigation nodes/edges, ambulance response estimate, emergency-department flag, LOD tier, and render binding. |
| Education anchor | Parent education civic anchor, building/parcel/district/road/service-area references, school/library/university/childcare/learning-campus kind, learner demand, entrance/drop-off/transit/bike/playground access refs, student/classroom/library/childcare/lecture/staff capacity, pedestrian coverage navigation nodes/edges, access score, LOD tier, and render binding. |
| Emergency service anchor | Parent emergency civic anchor, building/parcel/district/road/service-area references, anchor kind, response mode, dispatch unit/responder/vehicle capacity, 24h priority, coverage districts/roads/fire-safety profiles, estimated response time, staging/shelter/command readiness, emergency navigation nodes/edges, fire lanes, service corridors, hydrants, LOD tier, and render binding. |
| Emergency equipment | Parent emergency service anchor, equipment kind, road/public-space/shelter/sign references, center point, public-space coverage, nearest assembly point and shelter, navigation/fire-lane access, device or audible/capacity metrics, LOD tier, and render binding. |
| Water transport access | Parent waterfront open space, waterfront edge, freight route, or emergency service anchor; access kind; arrival mode; waterway/dock/waterfront/freight/emergency references; road and navigation graph links; passenger/cargo/berth/emergency capacity; vessel, clearance, weather, hazmat, night, and emergency-priority constraints; schedule profile; LOD tier; and render binding. |
| Wind comfort zone | Parent road, building, park, plaza, or waterfront open space; zone kind; weather preset; prevailing wind; base and gust wind speed; comfort, shelter, acceleration, downdraft, and waterfront exposure scores; pedestrian warning flag; boundary; and references to related buildings, roads, public spaces, waterway crossings, trees, and solar/shading samples. |
| Economy anchor | Parent building, parcel/district/road references, center point, economic use, primary land use, schedule profile, active frontage/address links, estimated jobs, peak workers, customer demand, delivery demand, opening hours, frontage needs, loading needs, freight dock/route references, district fit score, zoning compatibility, LOD tier, and source metadata. |
| Office workplace | Parent economy anchor, building/parcel/district/road references, center point, office/coworking/institutional/industrial-administration kind, office floor area and floor count, tower/podium/skyline metadata, lobby access/entrance/address references, tenancy capacity, commute mode demand, transit and bike parking references, peak arrival/departure hooks, daytime population, LOD tier, and source metadata. |
...
| Sensor | Operations-owned camera, counter, meter, weather, or air-quality device with mounted-object parentage, position, sensor kind, mount kind, telecom/utility/inventory/maintenance links, coverage geometry and referenced roads/buildings/public spaces/environment zones, telemetry streams, privacy tags, operational status, LOD tier, and source metadata. |
...
The first executable city validator is `src/city/data-contracts/validation/validateGeneratedCity.ts`. It currently checks duplicate IDs, object-kind registry ID patterns, required/forbidden parent rules, parent-kind compatibility, source metadata completeness, LOD tier policy coverage, asset catalog and render binding integrity, geospatial frame metadata, finite local x/z coordinates, local coordinate bounds/tolerances, height datum bounds, district character rules and transition buffers, constraint boundaries/references/conflicts/setbacks/clearances, hazard-zone boundaries/references/mitigation/prohibited-object conflicts, access-control geometry/rule/mode/reference integrity, operations asset inventory coverage for renderable civic/healthcare/education/emergency-service/emergency-equipment/public-realm/water-transport/utility assets, maintenance operation coverage for watched assets, schedules, repair queues, condition updates, replacement estimates, service access, temporary closure route references, permit/inspection source references, approval state, inspection state, compliance consistency, closure permits, sensor mounted-object references, coverage references, telemetry stream metadata, privacy tags, telecom/utility/environment/maintenance links, and operational status, curb activation permits, parent curb zones, safe curb uses, seasonal windows, barriers, clearances, and bindings, public amenity parentage, accessibility, utility service, service access, comfort capacity, and bindings, district/block relationships, utility service networks including power, water, wastewater, stormwater, telecom, gas, and district energy, road lane/sidewalk structure, curb and crossing relationships, public-realm furnishing-zone placement, public lighting coverage/night-safety/glare integrity, green stormwater road/sidewalk/utility/runoff/tree references, parcel frontage and zoning fields, building parcel fit/coverage/use/height/public entrances, building fire-safety hydrant reach, fire lanes, egress, sprinklers, refuge areas, emergency service access, healthcare anchor parentage, patient/care capacity, coverage navigation, ambulance route hooks, emergency-department rules, education anchor parentage, learner capacity, drop-off/transit/bike/playground access, pedestrian coverage, emergency service anchor parentage, dispatch capacity, response coverage, staging/shelter readiness, emergency navigation access, emergency equipment parentage/kind coverage/public-space coverage/shelter and assembly links/navigation and signage access, water transport parentage/capacity/routing/waterway/freight/emergency/binding coverage, wind comfort kind/risk coverage, weather and parent references, pedestrian warning flags, public-space/tall-building/waterfront/bridge references, economy anchor building/parcel/road references, jobs, customer demand, delivery demand, opening hours, frontage/loading needs, freight links, district fit, office workplace economy-anchor/building/parcel/road references, lobby/address links, office capacity, tenancy, commute mode demand, transit/bike hooks, active frontage facade references and storefront metadata, and tree parent references. Runtime traffic and marking output is checked by `src/city/data-contracts/validation/validateTrafficPlan.ts`, including lane-marking and traffic-vehicle registry IDs plus road/lane/route/speed/stop/source metadata and LOD policy compliance. Validators should expand before each new city slice lands.
