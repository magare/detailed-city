...
- Education anchor render bindings use a procedural civic-building marker, registered education-anchor material zone, and building fallback material so schools, libraries, universities, childcare, and learning campuses remain inspectable before dedicated education facility assets land.
...
- Emergency equipment render bindings use a procedural street-prop marker, registered emergency-equipment material zone, and sign fallback material so AEDs, phones, sirens, alarms, fire alarm boxes, assembly areas, lifeguard stations, and shelter signage remain inspectable before dedicated safety fixture assets land.
