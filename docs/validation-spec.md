...
- Operations asset inventory coverage validates one record per renderable civic/healthcare/emergency-service/public-realm/water-transport/utility target, target parentage and kind, owner/department/source metadata, lifecycle/warranty/replacement-cost/condition coherence, inspection-access references, render binding IDs, and catalog asset references.
