...
| Office workplaces | Office towers, coworking spaces, institutional workplaces, and industrial administration offices resolve parent economy anchors, buildings, parcels, districts, roads, lobbies, addresses, transit stops, and bike parking; expose valid office floors, tenancy, daytime population, commute mode splits, and peak arrival/departure hooks. |
...
| Sensors and IoT | Cameras, counters, meters, weather stations, and air-quality sensors resolve mounted objects, telecom/utility/inventory/maintenance/environment links, coverage targets, telemetry streams, privacy tags, and operational status. |
...
- Office workplace validation checks required office/coworking/institutional/industrial-administration kinds, parent economy anchors, matching building/parcel/district/road references, lobby access/entrance/address integrity, office floor and tenancy capacity, daytime population, commute mode totals, peak arrival/departure hours, transit stop references, and bike parking references.
...
- Sensor and IoT validation checks required sensor kinds and mount kinds, mounted-object parentage, inventory/telecom/utility/maintenance/environment references, coverage geometry and target refs, telemetry cadence/retention/sample quality, privacy/visibility tags, and operational status.
