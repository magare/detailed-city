...
test('debug panel exposes current city diagnostics and can collapse', async ({ page }) => {
  ...
  expect(panelText).toContain('16105/16105 tagged');
  ...
  expect(panelText).toContain('6 formats, 15148 objects');
