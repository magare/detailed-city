...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      ownerDomainOverlayFeatures: 5923,
      ...
      importExportProceduralObjects: 4966,
      ...
      metadataTaggedObjects: 5923,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 5916,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 48,
      lodObjectsWithPolicy: 5923,
