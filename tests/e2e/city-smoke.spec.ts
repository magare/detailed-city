...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      networkLayerObjects: 976,
      agentLayerObjects: 7,
      overlayDatasets: 13,
      overlayFeatures: 5600,
      ...
      ownerDomainOverlayFeatures: 4880,
      pickableObjects: 1748,
      ...
      importExportProceduralObjects: 3923,
      ...
      metadataTaggedObjects: 4880,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 4873,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 34,
      lodObjectsWithPolicy: 4880,
