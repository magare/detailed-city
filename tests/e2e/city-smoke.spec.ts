...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      agentLayerObjects: 7,
      overlayDatasets: 6,
      overlayFeatures: 5361,
      overlayIds: 'districts,constraints,parcels,roads,validation-issues,owner-domains',
      validationOverlayFeatures: 0,
      ownerDomainOverlayFeatures: 4757,
      ...
      importExportProceduralObjects: 3818,
      ...
      baselineScenarioObjects: 4757,
      registeredObjectKinds: 28,
      registryKinds: 28,
      ...
      metadataTaggedObjects: 4757,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 4750,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 28,
      lodObjectsWithPolicy: 4757,
