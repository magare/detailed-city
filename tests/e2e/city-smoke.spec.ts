...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      ownerDomainOverlayFeatures: 5947,
      ...
      importExportProceduralObjects: 4990,
      ...
      metadataTaggedObjects: 5947,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 5940,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 48,
      lodObjectsWithPolicy: 5947,
