...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      agentLayerObjects: 7,
      overlayDatasets: 11,
      overlayFeatures: 5539,
      overlayIds: 'administrative-boundaries,districts,zoning,waterways,city-metrics,constraints,resilience-goals,parcels,roads,validation-issues,owner-domains',
      validationOverlayFeatures: 0,
      ownerDomainOverlayFeatures: 4836,
      pickableObjects: 1719,
      ...
      importExportProceduralObjects: 3897,
      ...
      baselineScenarioObjects: 4836,
      registeredObjectKinds: 32,
      registryKinds: 32,
      ...
      metadataTaggedObjects: 4836,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 4829,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 32,
      lodObjectsWithPolicy: 4836,
