...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      ownerDomainOverlayFeatures: 12017,
      pickableObjects: 2151,
      ...
      importExportProceduralObjects: 11060,
      ...
      baselineScenarioObjects: 12017,
      registeredObjectKinds: 63,
      registryKinds: 63,
      ...
      metadataTaggedObjects: 12017,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 12010,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 63,
      lodObjectsWithPolicy: 12017,
