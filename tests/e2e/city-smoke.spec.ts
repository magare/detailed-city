...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      ownerDomainOverlayFeatures: 4944,
      pickableObjects: 1790,
      ...
      importExportProceduralObjects: 3987,
      ...
      metadataTaggedObjects: 4944,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 4937,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 40,
      lodObjectsWithPolicy: 4944,
