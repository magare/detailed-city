...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      agentLayerObjects: 7,
      overlayDatasets: 22,
      overlayFeatures: 6107,
      overlayIds: 'administrative-boundaries,districts,zoning,waterways,waterfront,hazards,topography,soil-geology,phasing,weather-presets,solar-shading,city-metrics,civic-anchors,community-anchors,culture-anchors,government-anchors,constraints,resilience-goals,parcels,roads,validation-issues,owner-domains',
      validationOverlayFeatures: 0,
      ownerDomainOverlayFeatures: 5312,
      ...
      importExportProceduralObjects: 4355,
      ...
      metadataTaggedObjects: 5312,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 5305,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 46,
      lodObjectsWithPolicy: 5312,
