...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      ownerDomainOverlayFeatures: 5956,
      ...
      importExportProceduralObjects: 4999,
      ...
      metadataTaggedObjects: 5956,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 5949,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 48,
      lodObjectsWithPolicy: 5956,
