...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      ownerDomainOverlayFeatures: 5036,
      pickableObjects: 1882,
      ...
      importExportProceduralObjects: 4079,
      ...
      metadataTaggedObjects: 5036,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 5029,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 40,
      lodObjectsWithPolicy: 5036,
