...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      ownerDomainOverlayFeatures: 4906,
      ...
      importExportProceduralObjects: 3949,
      ...
      baselineScenarioObjects: 4906,
      registeredObjectKinds: 38,
      registryKinds: 38,
      ...
      metadataTaggedObjects: 4906,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 4899,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 38,
      lodObjectsWithPolicy: 4906,
