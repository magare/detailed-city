...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      ownerDomainOverlayFeatures: 11273,
      ...
      importExportProceduralObjects: 10316,
      ...
      metadataTaggedObjects: 11273,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 11266,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 62,
      lodObjectsWithPolicy: 11273,
