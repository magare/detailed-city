...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      ownerDomainOverlayFeatures: 8570,
      ...
      importExportProceduralObjects: 7613,
      ...
      metadataTaggedObjects: 8570,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 8563,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 59,
      lodObjectsWithPolicy: 8570,
