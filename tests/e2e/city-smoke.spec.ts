...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      agentLayerObjects: 7,
      overlayDatasets: 12,
      overlayFeatures: 5562,
      overlayIds: 'administrative-boundaries,districts,zoning,waterways,waterfront,city-metrics,constraints,resilience-goals,parcels,roads,validation-issues,owner-domains',
      validationOverlayFeatures: 0,
      ownerDomainOverlayFeatures: 4848,
      pickableObjects: 1730,
      ...
      baselineScenarioObjects: 4848,
      registeredObjectKinds: 33,
      registryKinds: 33,
      ...
      metadataTaggedObjects: 4848,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 4841,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 33,
      lodObjectsWithPolicy: 4848,
