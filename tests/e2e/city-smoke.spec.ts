...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      agentLayerObjects: 7,
      overlayDatasets: 16,
      overlayFeatures: 5670,
      overlayIds: 'administrative-boundaries,districts,zoning,waterways,waterfront,hazards,topography,soil-geology,phasing,city-metrics,constraints,resilience-goals,parcels,roads,validation-issues,owner-domains',
      validationOverlayFeatures: 0,
      ownerDomainOverlayFeatures: 4937,
      pickableObjects: 1784,
      ...
      importExportProceduralObjects: 3980,
      ...
      metadataTaggedObjects: 4937,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 4930,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 39,
      lodObjectsWithPolicy: 4937,
