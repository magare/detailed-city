...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      ownerDomainOverlayFeatures: 7676,
      ...
      importExportProceduralObjects: 6719,
      ...
      metadataTaggedObjects: 7676,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 7669,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 53,
      lodObjectsWithPolicy: 7676,
