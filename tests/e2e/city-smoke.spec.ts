...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      agentLayerObjects: 7,
      overlayDatasets: 15,
      overlayFeatures: 5633,
      overlayIds: 'administrative-boundaries,districts,zoning,waterways,waterfront,hazards,topography,soil-geology,city-metrics,constraints,resilience-goals,parcels,roads,validation-issues,owner-domains',
      validationOverlayFeatures: 0,
      ownerDomainOverlayFeatures: 4903,
      ...
      importExportProceduralObjects: 3946,
      ...
      baselineScenarioObjects: 4903,
      registeredObjectKinds: 37,
      registryKinds: 37,
      ...
      metadataTaggedObjects: 4903,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 4896,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 37,
      lodObjectsWithPolicy: 4903,
