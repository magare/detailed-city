...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      cityMetricWalkability: 96.47,
      cityMetricDensity: 1956.17,
      ...
      agentLayerObjects: 7,
      overlayDatasets: 9,
      overlayFeatures: 5427,
      overlayIds: 'administrative-boundaries,districts,city-metrics,constraints,resilience-goals,parcels,roads,validation-issues,owner-domains',
      validationOverlayFeatures: 0,
      ownerDomainOverlayFeatures: 4790,
      pickableObjects: 1699,
      ...
      importExportProceduralObjects: 3851,
      ...
      baselineScenarioObjects: 4790,
      registeredObjectKinds: 31,
      registryKinds: 31,
      ...
      metadataTaggedObjects: 4790,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 4783,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 31,
      lodObjectsWithPolicy: 4790,
