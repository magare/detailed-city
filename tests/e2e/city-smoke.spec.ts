...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      ownerDomainOverlayFeatures: 4854,
      ...
      importExportProceduralObjects: 3915,
      ...
      metadataTaggedObjects: 4854,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 4847,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 34,
      lodObjectsWithPolicy: 4854,
