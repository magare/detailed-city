...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      ownerDomainOverlayFeatures: 5329,
      ...
      importExportProceduralObjects: 4372,
      ...
      metadataTaggedObjects: 5329,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 5322,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 47,
      lodObjectsWithPolicy: 5329,
