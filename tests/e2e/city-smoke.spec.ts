...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      ownerDomainOverlayFeatures: 5995,
      ...
      importExportProceduralObjects: 5038,
      ...
      metadataTaggedObjects: 5995,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 5988,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 48,
      lodObjectsWithPolicy: 5995,
