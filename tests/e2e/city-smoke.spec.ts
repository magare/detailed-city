...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      agentLayerObjects: 7,
      overlayDatasets: 20,
      overlayFeatures: 6049,
      overlayIds: 'administrative-boundaries,districts,zoning,waterways,waterfront,hazards,topography,soil-geology,phasing,city-metrics,civic-anchors,community-anchors,culture-anchors,government-anchors,constraints,resilience-goals,parcels,roads,validation-issues,owner-domains',
      validationOverlayFeatures: 0,
      ownerDomainOverlayFeatures: 5283,
      ...
      importExportProceduralObjects: 4326,
      ...
      metadataTaggedObjects: 5283,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 5276,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 44,
      lodObjectsWithPolicy: 5283,
