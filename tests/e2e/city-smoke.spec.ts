...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      agentLayerObjects: 7,
      overlayDatasets: 14,
      overlayFeatures: 5623,
      overlayIds: 'administrative-boundaries,districts,zoning,waterways,waterfront,hazards,topography,city-metrics,constraints,resilience-goals,parcels,roads,validation-issues,owner-domains',
      validationOverlayFeatures: 0,
      ownerDomainOverlayFeatures: 4898,
      ...
      importExportProceduralObjects: 3941,
      ...
      baselineScenarioObjects: 4898,
      registeredObjectKinds: 36,
      registryKinds: 36,
      ...
      metadataTaggedObjects: 4898,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 4891,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 36,
      lodObjectsWithPolicy: 4898,
