...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      ownerDomainOverlayFeatures: 5912,
      ...
      importExportProceduralObjects: 4955,
      ...
      metadataTaggedObjects: 5912,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 5905,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 48,
      lodObjectsWithPolicy: 5912,
