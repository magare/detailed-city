...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      agentLayerObjects: 7,
      overlayDatasets: 8,
      overlayFeatures: 5391,
      overlayIds: 'districts,city-metrics,constraints,resilience-goals,parcels,roads,validation-issues,owner-domains',
      validationOverlayFeatures: 0,
      ownerDomainOverlayFeatures: 4772,
      ...
      importExportProceduralObjects: 3833,
      ...
      baselineScenarioObjects: 4772,
      registeredObjectKinds: 30,
      registryKinds: 30,
      ...
      metadataTaggedObjects: 4772,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 4765,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 30,
      lodObjectsWithPolicy: 4772,
