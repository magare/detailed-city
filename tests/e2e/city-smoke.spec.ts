...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      ownerDomainOverlayFeatures: 16092,
      pickableObjects: 6226,
      ...
      baselineScenarioObjects: 16092,
      registeredObjectKinds: 67,
      registryKinds: 67,
      ...
      metadataTaggedObjects: 16092,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 16085,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 67,
      lodObjectsWithPolicy: 16092,
