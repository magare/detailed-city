...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      agentLayerObjects: 7,
      overlayDatasets: 17,
      overlayFeatures: 6004,
      overlayIds: 'administrative-boundaries,districts,zoning,waterways,waterfront,hazards,topography,soil-geology,phasing,city-metrics,civic-anchors,constraints,resilience-goals,parcels,roads,validation-issues,owner-domains',
      validationOverlayFeatures: 0,
      ownerDomainOverlayFeatures: 5259,
      pickableObjects: 2102,
      ...
      importExportProceduralObjects: 4302,
      ...
      metadataTaggedObjects: 5259,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 5252,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 41,
      lodObjectsWithPolicy: 5259,
