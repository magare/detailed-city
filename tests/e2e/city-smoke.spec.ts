...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      agentLayerObjects: 7,
      overlayDatasets: 18,
      overlayFeatures: 6015,
      overlayIds: 'administrative-boundaries,districts,zoning,waterways,waterfront,hazards,topography,soil-geology,phasing,city-metrics,civic-anchors,government-anchors,constraints,resilience-goals,parcels,roads,validation-issues,owner-domains',
      validationOverlayFeatures: 0,
      ownerDomainOverlayFeatures: 5265,
      pickableObjects: 2107,
      ...
      importExportProceduralObjects: 4308,
      ...
      metadataTaggedObjects: 5265,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 5258,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 42,
      lodObjectsWithPolicy: 5265,
