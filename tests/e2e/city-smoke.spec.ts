...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      importExportProceduralObjects: 3820,
      ...
      metadataTaggedObjects: 4759,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 4752,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 27,
      lodObjectsWithPolicy: 4759,
