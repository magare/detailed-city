...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      agentLayerObjects: 7,
      overlayDatasets: 21,
      overlayFeatures: 6059,
      overlayIds: 'administrative-boundaries,districts,zoning,waterways,waterfront,hazards,topography,soil-geology,phasing,weather-presets,city-metrics,civic-anchors,community-anchors,culture-anchors,government-anchors,constraints,resilience-goals,parcels,roads,validation-issues,owner-domains',
      validationOverlayFeatures: 0,
      ownerDomainOverlayFeatures: 5288,
      ...
      importExportProceduralObjects: 4331,
      ...
      metadataTaggedObjects: 5288,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 5281,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 45,
      lodObjectsWithPolicy: 5288,
