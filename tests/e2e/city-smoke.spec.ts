...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      ownerDomainOverlayFeatures: 5254,
      pickableObjects: 2098,
      ...
      importExportProceduralObjects: 4297,
      ...
      metadataTaggedObjects: 5254,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 5247,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 41,
      lodObjectsWithPolicy: 5254,
