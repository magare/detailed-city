...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      ownerDomainOverlayFeatures: 5245,
      pickableObjects: 2090,
      ...
      importExportProceduralObjects: 4288,
      ...
      metadataTaggedObjects: 5245,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 5238,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 40,
      lodObjectsWithPolicy: 5245,
