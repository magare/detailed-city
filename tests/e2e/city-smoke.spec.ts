...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      ownerDomainOverlayFeatures: 15370,
      pickableObjects: 5504,
      ...
      importExportProceduralObjects: 14413,
      ...
      baselineScenarioObjects: 15370,
      registeredObjectKinds: 65,
      registryKinds: 65,
      ...
      metadataTaggedObjects: 15370,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 15363,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 65,
      lodObjectsWithPolicy: 15370,
