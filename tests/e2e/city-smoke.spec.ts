...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      ownerDomainOverlayFeatures: 4831,
      ...
      importExportProceduralObjects: 3892,
      ...
      metadataTaggedObjects: 4831,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 4824,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 31,
      lodObjectsWithPolicy: 4831,
