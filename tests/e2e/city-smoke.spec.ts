...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      ownerDomainOverlayFeatures: 6024,
      ...
      importExportProceduralObjects: 5067,
      ...
      metadataTaggedObjects: 6024,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 6017,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 50,
      lodObjectsWithPolicy: 6024,
