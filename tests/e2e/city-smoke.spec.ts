...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      ownerDomainOverlayFeatures: 5969,
      ...
      importExportProceduralObjects: 5012,
      ...
      metadataTaggedObjects: 5969,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 5962,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 48,
      lodObjectsWithPolicy: 5969,
