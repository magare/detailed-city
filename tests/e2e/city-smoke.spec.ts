...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      ownerDomainOverlayFeatures: 5936,
      ...
      importExportProceduralObjects: 4979,
      ...
      metadataTaggedObjects: 5936,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 5929,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 48,
      lodObjectsWithPolicy: 5936,
