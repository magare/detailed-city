...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      agentLayerObjects: 7,
      overlayDatasets: 7,
      overlayFeatures: 5375,
      overlayIds: 'districts,constraints,resilience-goals,parcels,roads,validation-issues,owner-domains',
      validationOverlayFeatures: 0,
      ownerDomainOverlayFeatures: 4764,
      ...
      importExportProceduralObjects: 3825,
      ...
      baselineScenarioObjects: 4764,
      registeredObjectKinds: 29,
      registryKinds: 29,
      ...
      metadataTaggedObjects: 4764,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 4757,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 29,
      lodObjectsWithPolicy: 4764,
