...
test('renders a nonblank WebGL city scene', async ({ page }, testInfo) => {
  ...
  await expect
    ...
    .toEqual({
      ...
      ownerDomainOverlayFeatures: 7274,
      ...
      importExportProceduralObjects: 6317,
      ...
      metadataTaggedObjects: 7274,
      metadataMissingObjects: 0,
      metadataProceduralObjects: 7267,
      metadataSimulatedObjects: 7,
      lodPolicyTiers: 5,
      lodObjectPolicies: 50,
      lodObjectsWithPolicy: 7274,
